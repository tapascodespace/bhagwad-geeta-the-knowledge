...
const krishnaLeelasHindi: BookSection[] = [
  {
    id: 1,
    title: "कृष्ण का जन्म",
    body: "मथुरा में अत्याचारी कंस के डर से हर कोई सहमा हुआ था। उसी अंधकार के बीच, आधी रात को श्रीकृष्ण का जन्म हुआ। जेल के दरवाजे अपने आप खुल गए और पहरेदार सो गए। वसुदेव ने नवजात कृष्ण को टोकरी में रखकर यमुना पार कर गोकुल पहुंचाया। यह घटना दिखाती है कि जब समय आता है, तो प्रकृति भी बदलाव का साथ देती है।",
    takeaway: "सबसे कठिन समय में भी परिवर्तन की शुरुआत हो सकती है।",
  },
  {
    id: 2,
    title: "गोकुल की शुरुआत",
    body: "गोकुल में कृष्ण का पालन-पोषण नंद बाबा और यशोदा ने किया। एक साधारण गांव में, गायों और ग्वालों के बीच, कृष्ण ने अपना बचपन बिताया। यह सादगी भरा जीवन हमें सिखाता है कि असली खुशी भव्यता में नहीं, बल्कि सरलता और अपनापन में होती है।",
    takeaway: "सच्ची खुशी सरल जीवन में छिपी होती है।",
  },
  {
    id: 3,
    title: "माखन चोर की लीला",
    body: "वृंदावन में कृष्ण की सबसे प्रसिद्ध लीला ‘माखन चोरी’ थी। घर में सब कुछ होते हुए भी, कृष्ण ग्वालिनों के घर जाकर माखन चुराते थे। वे और उनके मित्र मिलकर ऊंचे लटके मटकों तक पहुंचने के लिए योजना बनाते थे। यह लीला केवल शरारत नहीं थी, बल्कि प्रेम और आनंद फैलाने का तरीका थी।",
    takeaway: "जीवन में आनंद और रिश्तों की मिठास सबसे महत्वपूर्ण है।",
  },
  {
    id: 4,
    title: "पूतना वध",
    body: "कंस ने कृष्ण को मारने के लिए पूतना नामक राक्षसी को भेजा, जो एक सुंदर स्त्री का रूप धारण कर आई। उसने विष लगे स्तन से कृष्ण को दूध पिलाने की कोशिश की। लेकिन कृष्ण ने उसका जीवन ही समाप्त कर दिया और उसे मुक्ति भी दी। यह लीला दिखाती है कि सच्चाई के सामने छल टिक नहीं सकता।",
    takeaway: "बुराई चाहे कितनी भी चालाक हो, अंत में हारती है।",
  },
  {
    id: 5,
    title: "कालिया नाग का अंत",
    body: "यमुना नदी में कालिया नाग का विष फैला हुआ था, जिससे पूरा क्षेत्र संकट में था। कृष्ण ने नदी में कूदकर कालिया को पराजित किया और उसके फनों पर नृत्य किया। अंत में, उसे वहां से जाने का आदेश दिया। यह घटना साहस और संतुलन का प्रतीक है।",
    takeaway: "डर का सामना करने से ही समस्या का समाधान होता है।",
  },
  {
    id: 6,
    title: "गोवर्धन पर्वत उठाना",
    body: "जब इंद्र के अहंकार के कारण भारी वर्षा होने लगी, तब कृष्ण ने अपनी छोटी उंगली पर गोवर्धन पर्वत उठाकर पूरे गांव की रक्षा की। यह केवल शक्ति का प्रदर्शन नहीं था, बल्कि यह दिखाता है कि नेतृत्व का मतलब दूसरों की रक्षा करना है।",
    takeaway: "सच्चा नेता वही है जो दूसरों की रक्षा करे।",
  },
  {
    id: 7,
    title: "गोपियों का प्रेम",
    body: "वृंदावन की गोपियां कृष्ण से अत्यंत प्रेम करती थीं। उनका प्रेम किसी स्वार्थ या अपेक्षा पर आधारित नहीं था। वे केवल कृष्ण की उपस्थिति में ही संतुष्ट थीं। यह प्रेम हमें सिखाता है कि सच्चा संबंध बिना शर्त और पूर्ण विश्वास पर आधारित होता है।",
    takeaway: "सच्चा प्रेम बिना किसी अपेक्षा के होता है।",
  },
  {
    id: 8,
    title: "मिट्टी खाने की लीला",
    body: "एक दिन कृष्ण ने खेलते समय मिट्टी खा ली। जब यशोदा ने उनसे मुंह खोलने को कहा, तो उन्होंने पूरे ब्रह्मांड का दर्शन किया। यह लीला दिखाती है कि ईश्वर हर जगह है, यहां तक कि सबसे छोटी चीजों में भी।",
    takeaway: "हर छोटी चीज में भी बड़ा सत्य छिपा होता है।",
  },
  {
    id: 9,
    title: "उखल बंधन",
    body: "यशोदा ने कृष्ण को शरारत के कारण एक उखल से बांध दिया। लेकिन कृष्ण ने उसी उखल को खींचकर दो बड़े पेड़ों को गिरा दिया। यह घटना बताती है कि दिव्यता को कोई बंधन रोक नहीं सकता।",
    takeaway: "सच्ची शक्ति को सीमित नहीं किया जा सकता।",
  },
  {
    id: 10,
    title: "रास लीला",
    body: "रास लीला में कृष्ण ने प्रत्येक गोपी के साथ नृत्य किया, जिससे हर गोपी को लगा कि कृष्ण केवल उसके साथ हैं। यह लीला आत्मा और परमात्मा के गहरे संबंध का प्रतीक है।",
    takeaway: "आध्यात्मिक जुड़ाव सबसे गहरा होता है।",
  },
  {
    id: 11,
    title: "कंस वध",
    body: "कृष्ण बड़े होकर मथुरा पहुंचे और कंस को युद्ध में पराजित किया। इस प्रकार उन्होंने वर्षों से चले आ रहे अत्याचार का अंत किया और लोगों को भय से मुक्त किया।",
    takeaway: "अन्याय के खिलाफ खड़ा होना जरूरी है।",
  },
  {
    id: 12,
    title: "सुदामा की मित्रता",
    body: "कृष्ण के बचपन के मित्र सुदामा अत्यंत गरीब थे। जब वे कृष्ण से मिलने द्वारका आए, तो कृष्ण ने उनका स्वागत राजा की तरह किया। उन्होंने बिना कुछ मांगे ही सुदामा की गरीबी दूर कर दी।",
    takeaway: "सच्ची मित्रता परिस्थितियों से ऊपर होती है।",
  },
  {
    id: 13,
    title: "द्रौपदी की रक्षा",
    body: "महाभारत में जब द्रौपदी का चीरहरण हो रहा था, तब उसने कृष्ण को पुकारा। कृष्ण ने उसकी लाज बचाई और उसे अपमान से बचाया।",
    takeaway: "सच्ची श्रद्धा संकट में भी साथ नहीं छोड़ती।",
  },
  {
    id: 14,
    title: "गीता का उपदेश",
    body: "कुरुक्षेत्र के युद्ध में अर्जुन भ्रमित हो गए थे। तब कृष्ण ने उन्हें गीता का ज्ञान दिया, जिसमें जीवन, कर्तव्य और आत्मा के रहस्य बताए गए।",
    takeaway: "सही मार्गदर्शन जीवन की दिशा बदल सकता है।",
  },
  {
    id: 15,
    title: "रणनीति और बुद्धि",
    body: "महाभारत के युद्ध में कृष्ण ने अपनी बुद्धि और रणनीति से पांडवों की मदद की। उन्होंने दिखाया कि केवल शक्ति ही नहीं, सही सोच भी जीत दिलाती है।",
    takeaway: "सही रणनीति सफलता की कुंजी है।",
  },
  {
    id: 16,
    title: "विनम्रता",
    body: "भगवान होने के बावजूद, कृष्ण ने हमेशा विनम्रता बनाए रखी। उन्होंने कभी अपने अहंकार को अपने व्यवहार पर हावी नहीं होने दिया।",
    takeaway: "विनम्रता ही असली महानता है।",
  },
  {
    id: 17,
    title: "मित्र और मार्गदर्शक",
    body: "कृष्ण ने अर्जुन के लिए केवल सारथी नहीं, बल्कि एक सच्चे मित्र और मार्गदर्शक की भूमिका निभाई।",
    takeaway: "एक सही मार्गदर्शक जीवन बदल सकता है।",
  },
  {
    id: 18,
    title: "जीवन के सभी रूप",
    body: "कृष्ण ने जीवन के हर रूप को जिया — बालपन, मित्रता, प्रेम, युद्ध और ज्ञान।",
    takeaway: "जीवन को हर रूप में जीना ही पूर्णता है।",
  },
  {
    id: 19,
    title: "संतुलन",
    body: "कृष्ण ने दिखाया कि कैसे एक व्यक्ति जिम्मेदारियों और आनंद के बीच संतुलन बना सकता है।",
    takeaway: "संतुलन ही सफल जीवन की कुंजी है।",
  },
  {
    id: 20,
    title: "जीवन का संदेश",
    body: "कृष्ण की लीलाएं केवल कहानियां नहीं हैं, बल्कि जीवन के गहरे सत्य हैं जो हमें हर परिस्थिति में सही रास्ता दिखाते हैं।",
    takeaway: "जीवन को समझने के लिए इन लीलाओं से सीख लें।",
  },
];
...
const krishnaLeelasEnglish: BookSection[] = [
  ...
  },
  {
    id: 3,
    title: "Butter Thief",
    body: "The story of the 'Makhan Chor' describes the playful antics of the young Lord Krishna in the village of Vrindavan. Despite having plenty of butter at home, Krishna would sneak into the houses of the local cowherd women (Gopis) to 'steal' their freshly churned butter. To prevent Krishna from eating their supplies, the Gopis would hang their butter pots in earthen jars high from the ceiling. However, Krishna and his friends developed ingenious methods to reach them.",
...
export const books: Book[] = [
  ...
  },
  {
    ...
    titleEn: "The Gita for Students",
    authorEn: "Study Companion",
    descriptionEn: "The Gita's teachings on focus, hard work, and exam stress.",
    price: 49,
